...
file <- system.file("extdata", "DC_counts.rda", package = "singIST")
load(file)
counts_dc <- DC_counts
...
file <- system.file("extdata", "cytokine_counts.rda", package = "singIST")
load(file)
...
```{r}
# Load the disease model Seurat/SingleCellExperiment object scRNA-seq
file <- system.file("extdata", "OXA.rda", package = "singIST")
load(file)
oxazolone <- OXA
...
```{r}
# To render the output in a plotting-friendly manner, render_multiple_outputs
# can accommodate a single or multiple disease model outputs to have a 
# plotting-friendly data structure 
