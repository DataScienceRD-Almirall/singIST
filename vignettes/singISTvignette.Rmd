...
dc_superpathway <- setRepeatGeneSets(dc_superpathway) 
...
cytokine_superpathway <- methods::new(
    ...
    celltypes = c("Dendritic Cells", "Keratinocytes", "Langerhan Cells",
                    "Melanocytes", "T-cell"))
# Pull Gene Set 
gene_set <- pullGeneSet(cytokine_pathway)
...
# should contain the same cell types as the cell types used in the human
# superpathway
dc_oxa_org <- new("mapping.organism", organism = "Mus musculus", 
...
cytokine_oxa_org <- new("mapping.organism", organism = "Mus musculus", 
                target_class = "OXA", base_class = "ETOH",
                celltype_mapping = list(
                    "Dendritic Cells" = c("cDC2", "cDC1", "migratory DCs"),
...
# "object_gene_idetnifiers"
recapitulations_dc <- singISTrecapitulations(dc_oxa_org,
                                                superpathways_fit[[1]])
recapitulations_cytokine <- singISTrecapitulations(cytokine_oxa_org, 
                                                    superpathways_fit[[2]])
```
